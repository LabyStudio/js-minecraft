...
export class BlockRegistry {
    ...
    static create() {
        ...
        BlockRegistry.WOOL_WHITE = new BlockWool(35, 38,0);
        BlockRegistry.WOOL_ORANGE = new BlockWool(35, 28,1);
        BlockRegistry.WOOL_MAGENTA = new BlockWool(35, 36,2);
        BlockRegistry.WOOL_LIGHTBLUE = new BlockWool(35, 33,3);
        BlockRegistry.WOOL_YELLOW = new BlockWool(35, 29,4);
        BlockRegistry.WOOL_LIME = new BlockWool(35, 30,5);
        BlockRegistry.WOOL_PINK = new BlockWool(35, 37,6);
        BlockRegistry.WOOL_GRAY = new BlockWool(35, 40,7);
        BlockRegistry.WOOL_LIGHTGRAY = new BlockWool(35, 39,8);
        BlockRegistry.WOOL_CYAN = new BlockWool(35, 32,9);
        BlockRegistry.WOOL_PURPLE = new BlockWool(35, 35,10);
        BlockRegistry.WOOL_BLUE = new BlockWool(35, 34,11);
        BlockRegistry.WOOL_BROWN = new BlockWool(35, 42,12);
        BlockRegistry.WOOL_GREEN = new BlockWool(35, 31,13);
        BlockRegistry.WOOL_RED = new BlockWool(35, 27,14);
        BlockRegistry.WOOL_BLACK = new BlockWool(35, 41,15);
